...
const Navigation = () => {
  ...
  return  <div className={`navigation ${nav && "active"} 
    ...
    <Nav title={'Dashboard'} Icon={MdSpaceDashboard}/>
    <Nav title={'Analytics'} Icon={VscGraphLine}/>
    <Nav title={'Messages'} Icon={TbMessages}/>
    ...
    <Nav title={`${DarkTheme ? "Switch to Light Theme":
                "Switch to Dark Theme"}`} Icon={MdSwapHoriz} onClick={changeTheme}/>
